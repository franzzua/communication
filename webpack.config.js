...
module.exports = {
    ...
    resolve: {
        ...
        // },
        alias: {
            // "solidocity": path.resolve(__dirname, "../solidocity/dist/esm/yjs-webrtc.provider.ts.js"),
            // "@m-ld/m-ld": path.resolve(__dirname, "../m-ld-js"),
            // "@m-ld/m-ld$": path.resolve(__dirname, "../m-ld-js"),
            // "node-fetch": path.resolve(__dirname,"../solidocity/polyfills/global.js"),
            // 'solid-auth-client': `${__dirname}/node_modules/solid-auth-client/browser/yjs-webrtc.provider.ts.js`,
